...
<div class="page-container">
    <form action="/column/edit" method="post" class="form form-horizontal" id="form-category-add">
        <div id="tab-category" class="HuiTab">
            ...
            <div class="tabCon">
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9"><%=request.getSession().getAttribute("id")%></div>
                </div>
                <!--<div class="row cl">-->
