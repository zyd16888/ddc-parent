...
<div class="page-container">
    <div class="text-c">
            ...
            <button name="" id="btn" class="btn btn-success"><i class="Hui-iconfont">&#xe665;</i> 搜索
    </div>
                ...
                for (var i = 0; i < data.data.length; i++) {
                    ...
                    if (d.columnDeleteFlag == 0) {
                        ...
                        var li = "<tr class=\"text-c\">\n" +
                            ...
                            "\t\t\t\t\t<td class=\"f-14\"><a title=\"编辑\" href=\"javascript:;\" onclick=\"system_category_edit(this,'栏目编辑','article_column-edit?id="+d.columnId+"','3','700','480')\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i></a>\n" +
...
<script type="text/javascript">
    ...
    /*批量删除*/
    function datadel() {
        var checkedNum = $("input[name='batches']:checked").length;
        if (checkedNum == 0) {2
            alert("请至少选择一项!");
            return false;
        }
                ...
                for (var i = 0; i < data.data.length; i++) {
                    ...
                    if (d.columnDeleteFlag == 0) {
                        var li = "<tr class=\"text-c\">\n" +
                            ...
                            "\t\t\t\t\t<td>" + sort + "</td>\n" +
                            "\t\t\t\t\t<td class=\"text-l\">" + d.columnName + "</td>\n" +
                            "\t\t\t\t\t<td class=\"f-14\"><a title=\"编辑\" href=\"javascript:;\" onclick=\"system_category_edit('栏目编辑','/column/edit','3','700','480')\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i></a>\n" +
                            "\t\t\t\t\t\t<a href=\"javascript:;\" onclick='system_category_del(this)' title=\"删除\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i></a></td>\n" +
                            "\t\t\t\t</tr>";
                        sort++;
                        $("#table").append(li);
                    }
